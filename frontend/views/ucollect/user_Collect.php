   ...
   <!--收藏样式-->
    <div class="Collect" >
      <ul class="Collect_list">
       ...
       <li>
       <div class="Collect_pro_name" id="div1">
           <input type="hidden" value="<?php echo $v['goods_id']?>" id="sel_id">
         <a href="javascript:del_list()" class="delete_Collect"></a>
        <p class="img center"><a href="index.php?r=pdetail/index&goods_id=<?php echo $v['goods_id']?>"><img src="public/images/<?php echo $v['goods_img']?>" /></a></p>
        <p><a href="#"><?php echo $v['goods_name']?></a></p>
        <p class="Collect_Standard">套装</p>
        <p class="Collect_price">￥<?php echo $v['goods_price']?></p>
        </div>
       </li>
          <?php }?>
          </div>
...
<!--        <p class="img center"><a href="#"><img src="public/images/product_img_17.png" /></a></p>-->
...
<script>
    function del_list(){
       // alert(213)
        ...
        $.ajax({
            type:'get',
            url:'index.php?r=ucollect/del_collect',
            data:'id='+id,
