    ...
    <div class=" right_style r_user_style">
      <div class="user_Borders">
       ...
       <div class="user_layout">
         <ul >
             <input type="hidden"  id="user_id" value="<?php   $session = Yii::$app->session;
             echo  $session->get('id');

             ?>">
             <li><label class="user_title_name">用户昵称：</label><input id="nickname" type="text"  class="add_text" required/><i>*</i></li>
          <li><label class="user_title_name">真实姓名：</label><input id="name" type="text"  class="add_text"/><i>*</i></li>

          <li><label class="user_title_name">手&nbsp;机&nbsp;号：</label><input id="phone" type="text"  class="add_text"/><i>*</i></li>
          <li><label class="user_title_name">邮箱地址：</label><input id="email" type="text"  class="add_text"/><i>*</i></li>
         </ul>
         <div class="operating_btn"><input name="name" type="submit" value="提交" onclick="ucenter()"  class="submit—btn"/></div>
         </div>
...
<!--      <li class="fixeBoxLi user"><a href="index.php?r=ucenter/index"> <span class="fixeBoxSpan"></span> <strong>用户</strong></a> </li>-->
...
<script>
    function ucenter(){
       ...
       // alert(email)
        $.ajax({
               type:'get',
               url:'index.php?r=uinfo/upuser',
               data:'id='+id+'&&nickname='+nickname+'&&username='+username+'&&phone='+phone+'&&email='+email,
