<?php /*<link href="css/public.css" rel="stylesheet" type="text/css">*/ ?>
<?php /*<script type="text/javascript" src="js/jquery.min.js"></script>*/ ?>
<?php /*<script type="text/javascript" src="js/global.js"></script>*/ ?>
<?php /*<script type="text/javascript" src="js/jquery.autotextarea.js"></script>*/ ?>
...
<div id="dcHead">
    <div id="head">
        ...
        <div class="nav">
			...
			<?php else: ?>
                    <li class="M noLeft"><a href="login">您好，
...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
        ...
        <ul>
            <li><a href="type"><i class="productCat"></i><em>商品分类</em></a></li>
            <li><a href="goods_list"><i class="product"></i><em>商品列表</em></a></li>
        </ul>
        <ul>
            <li><a href="type"><i class="productCat"></i><em>订单管理</em></a></li>
            <li><a href="order"><i class="product"></i><em>订单列表</em></a></li>
        </ul>
        <ul>
