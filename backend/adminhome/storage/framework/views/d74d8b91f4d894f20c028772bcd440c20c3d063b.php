    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       ...
       <th width="80" align="center">添加日期</th>
        ...
        <td style="width:200px"><a href="#"><?php echo e($v->goods_name); ?></a></td>
        <td style="width:100px" align="center"><a href="product.php?cat_id=3"><?php echo e($v->sort_name); ?></a></td>
        <td style="width:150px" align="center"><img src="../../../frontend/web/public/images/<?php echo e($v->goods_img); ?>" alt="该图片在前台yii框架中" width="100px"/></td>
        <td align="center"><?php echo e(date("Y-m-d H:i:s", $v->add_time)); ?></td>
        <td align="center">
                  <?php /*<a href="product.php?rec=edit&id=15">编辑</a> | */ ?>
            <a href="goodsdel?goods_id=<?php echo e($v->goods_id); ?>">删除</a>&nbsp;||&nbsp;<a href="gaddsku?goods_id=<?php echo e($v->goods_id); ?>">添加Sku</a>&nbsp;||&nbsp;<a
