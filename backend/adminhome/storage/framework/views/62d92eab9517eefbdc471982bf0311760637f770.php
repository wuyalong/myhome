...
<div id="urHere">DouPHP 管理中心<b>></b><strong>订单列表</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <form action="order_sou" method="post">
     <?php /*<select name="t_id" id="t_id">*/ ?>
      ...
      <?php /*</select>*/ ?>
        请输入商品名称：
     <input name="goods_name" type="text" class="inpMain" value="<?php echo e($goods_name); ?>" size="20" />
        请输入收货人：
        <input name="address_name" type="text" class="inpMain" value="<?php echo e($address_name); ?>" size="20" />
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
        ...
        <td style="width:200px"><a href="#"><?php echo e($v->order_total); ?></a></td>
    ...
    <div class="clear"></div>
    <div class="pager">总计 15 个记录，共 1 页，当前第 1 页 | <a href="order_sou?page=1&goods_name=<?php echo e($goods_name); ?>&address_name=<?php echo e($address_name); ?>">第一页</a> <a href="order_sou?page=<?php echo e($up); ?>">上一页</a>
        <a href="order_sou?page=<?php echo e($down); ?>">下一页</a> <a href="order_sou?page=<?php echo e($last); ?>">最末页</a></div>               </div>
 </div>
 <div class="clear"></div>
<div id="dcFooter">
 <div id="footer">
